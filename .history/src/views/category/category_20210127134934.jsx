...
import { EditOutlined, DeleteOutlined,SyncOutlined,CheckCircleOutlined,CheckCircleTwoTone} from '@ant-design/icons'
    ...
    const columns = [
      {
        ...
        },
        {
          ...
          render:(tag,record,index)=>{
            //   console.log(tag);
              return(
                  tag === 'true'?<>  <CheckCircleTwoTone twoToneColor="#52c41a" /></>: <> <CheckCircleTwoTone twoToneColor="#52c41a" /> </>
              )
          }
        },
        {
          ...
          render: (tag, record, index) => {
            // console.log(record);
            return (
                tag === '0' ? <di><Tag color="magenta">一级</Tag></di> : tag === '1' ? <><Tag color="green">二级</Tag></> : <><Tag color="blue">三级</Tag></>
            )
        }
        },
        {
