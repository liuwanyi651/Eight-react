...
const User = (props) => {
  ...
  function onChange(pageNumber,pageSize){
    ...
    dispatch(getUsers({
      pagenum: pageNumber, pagesize: pageSize, query: ''
    }))
  }
  ...
  return (
    <div>
      ...
      {/* 分页区域 */}
      <>
        <Pagination showQuickJumper defaultCurrent={1} defaultPageSize={5} total={25} onChange={onChange} 
          pageSizeOptions={[1,3,5,10]} showSizeChanger
        />
      </>
      {/* 弹出框区域 */}
      <>
