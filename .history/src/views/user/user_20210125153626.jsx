...
const User = (props) => {
  ...
  let [queryInf]=useState({current:'1',pageSize:'2',query: ''})
  ...
  function onChange(pageNumber) {
    ...
    dispatch(getUsers({
      current:current,pageSize:pageSize,query: ''
    }))
  }
  //pageSize 每页条数 变化的回调
  function onShowSizeChange(pageSizeNumber) {
    console.log('pageSize: ', pageSizeNumber);
  }
    ...
    <div>
      ...
      <>
        <Pagination showQuickJumper defaultCurrent={2} total={100} onChange={onChange} 
          onShowSizeChange={onShowSizeChange} current={current} pageSize={pageSize}
        />
      </>
      {/* 弹出框区域 */}
      <>
