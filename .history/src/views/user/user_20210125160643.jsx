...
const User = (props) => {
  ...
  function onChange(pageNumber,pageSize){
    ...
    setQueryInfo(queryInfo.pagenum=pageNumber,queryInfo.pagesize=pageSize)
    dispatch(getUsers(queryInfo))
    console.log(queryInfo);
  }
  //pageSize 变化的回调 current	当前页数
  function onShowSizeChange(current, size){
    console.log('Page: ', pageNumber);
    console.log('pageSize',pageSize);
    setQueryInfo(queryInfo.pagenum=  function onShowSizeChange(current, size){
